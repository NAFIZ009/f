...
const Category =(data)=>{
    ...
    catagories.forEach(catagory => {
        ...
        <button class="bg-transparent border-0" onclick="gNews(event,'${catagory.category_id}','${catagory.category_name}')">${catagory.category_name}</button>
        `;
